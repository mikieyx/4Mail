...
- **Primary Postconditions:** The task is added to the todo list, the task is added to the database as well
...
- **Primary Postconditions:** The user can see and click on multiple news articles
...
- **Primary Postconditions:** The user is able to register for an account and can now log in to send and receive chats and emails from or to other users. / The user is not able to register and has to re-do the registration form.
...
- **Primary Postconditions:** The user is able to send a message to the recipient(s) / The user is not able to send a message and has to re-enter a valid recipient email address
